...
INSERT INTO public.alembic_version VALUES ('76b7f0b574cb');
...
Conditional rendering in React works the same way conditions work in JavaScript. Use JavaScript operators like if or the conditional operator to create elements representing the current state, and let React update the UI to match them.', 33, 4, true, '2025-07-15 12:58:03.890662+05:30');
INSERT INTO public.roadmap_topics VALUES (38, 2, 'Composition vs Inheritance', 'React has a powerful composition model, and it is recommended to use composition instead of inheritance to reuse code between components.', 33, 5, true, '2025-07-15 12:58:43.485246+05:30');
INSERT INTO public.roadmap_topics VALUES (40, 2, 'Component Life Cycle', 'React components have a lifecycle consisting of three phases: Mounting, Updating, and Unmounting along with several “lifecycle methods” that you can override to run code at particular times in the process. It is not recommended to use lifecycle methods manually. Instead, use the useEffect hook with functional components.', 39, 1, true, '2025-07-15 13:04:56.290903+05:30');
INSERT INTO public.roadmap_topics VALUES (41, 2, 'Lists and Keys', 'When you render lists in React, you can use the key prop to specify a unique key for each item. This key is used to identify which item to update when you want to update a specific item.', 39, 2, true, '2025-07-15 13:06:17.3095+05:30');
INSERT INTO public.roadmap_topics VALUES (42, 2, 'Renders Props', 'The term ''render props'' refers to a technique for sharing code between React components using a prop whose value is a function. A component with a render prop takes a function that returns a React element and calls it instead of implementing its own render logic.', 39, 3, true, '2025-07-15 13:08:23.731153+05:30');
INSERT INTO public.roadmap_topics VALUES (43, 2, 'Refs', 'Refs provide a way to access DOM nodes or React elements created in the render method. In the typical React dataflow, props are the only way that parent components interact with their children. To modify a child, you re-render it with new props. However, there are a few cases where you need to imperatively modify a child outside of the typical dataflow. The child to be modified could be an instance of a React component, or it could be a DOM element. For both of these cases, React provides an escape hatch.', 39, 4, true, '2025-07-15 13:09:29.512874+05:30');
INSERT INTO public.roadmap_topics VALUES (11, 1, 'UPDATE Statement', 'The UPDATE statement in SQL is used to modify existing records in a table. It allows you to change the values of one or more columns based on specified conditions. The basic syntax includes specifying the table name, the columns to be updated with their new values, and optionally, a WHERE clause to filter which rows should be affected. UPDATE can be used in conjunction with subqueries, joins, and CTEs (Common Table Expressions) for more complex data modifications. It''s important to use UPDATE carefully, especially with the WHERE clause, to avoid unintended changes to data. In transactional databases, UPDATE operations can be rolled back if they''re part of a transaction that hasn''t been committed.', 5, 6, true, '2025-07-15 00:14:18.373894+05:30');
INSERT INTO public.roadmap_topics VALUES (56, 3, 'Learn the Basics', 'Python is a high-level, interpreted, general-purpose programming language. Its design philosophy emphasizes code readability with the use of significant indentation. Python is dynamically-typed and garbage-collected.', NULL, 1, true, '2025-07-15 13:38:16.426263+05:30');
INSERT INTO public.roadmap_topics VALUES (31, 2, 'CLI Tools', '', NULL, 1, true, '2025-07-15 12:47:56.379806+05:30');
INSERT INTO public.roadmap_topics VALUES (65, 3, 'Tuples', 'Tuples are immutable sequences, meaning that once a tuple is created, its elements cannot be changed. Tuples are often used to store related pieces of information. They are defined by placing the elements inside parentheses () separated by commas.', 56, 9, true, '2025-07-15 18:03:51.525788+05:30');
INSERT INTO public.roadmap_topics VALUES (32, 2, 'Vite', 'Vite is a build tool that aims to provide a faster and leaner development experience for modern web projects.', 31, 1, true, '2025-07-15 12:51:39.924215+05:30');
INSERT INTO public.roadmap_topics VALUES (34, 2, 'Functional Components', 'Functional components are some of the more common components that will come across while working in React. These are simply JavaScript functions. We can create a functional component to React by writing a JavaScript function. These functions may or may not receive data as parameters. In the functional Components, the return value is the JSX code to render to the DOM tree. Functional components can also have state which is managed using React hooks.', 33, 1, true, '2025-07-15 12:53:41.052654+05:30');
INSERT INTO public.roadmap_topics VALUES (35, 2, 'JSX', 'JSX stands for JavaScript XML. It allows writing HTML in JavaScript and converts the HTML tags into React elements.', 33, 2, true, '2025-07-15 12:54:34.940791+05:30');
INSERT INTO public.roadmap_topics VALUES (36, 2, 'Props vs State', 'Props (short for “properties”) and state are both plain JavaScript objects. While both hold information that influences the output of component render, they are different in one important way: props get passed to the component (similar to function parameters) whereas state is managed within the component (similar to variables declared within a function).', 33, 3, true, '2025-07-15 12:55:23.867342+05:30');
INSERT INTO public.roadmap_topics VALUES (66, 3, 'Sets', 'Python Set is an unordered collection of data types that is iterable, mutable, and has no duplicate elements. The order of elements in a set is undefined though it may consist of various elements. The major advantage of using a set, as opposed to a list, is that it has a highly optimized method for checking whether a specific element is contained in the set.', 56, 10, true, '2025-07-15 18:07:22.001757+05:30');
INSERT INTO public.roadmap_topics VALUES (60, 3, 'Loops', 'Loops are used to execute a block of code repeatedly.', 56, 4, true, '2025-07-15 15:50:22.51521+05:30');
INSERT INTO public.roadmap_topics VALUES (75, 3, 'Modules', 'Modules refer to a file containing Python statements and definitions. A file containing Python code, for example: example.py, is called a module, and its module name would be example. We use modules to break down large programs into small manageable and organized files. Furthermore, modules provide reusability of code.', NULL, 3, true, '2025-07-15 18:49:02.750696+05:30');
INSERT INTO public.roadmap_topics VALUES (78, 3, 'Lambdas', 'Python Lambda Functions are anonymous function means that the function is without a name. As we already know that the def keyword is used to define a normal function in Python. Similarly, the lambda keyword is used to define an anonymous function in Python.', NULL, 4, true, '2025-07-15 18:57:49.616698+05:30');
INSERT INTO public.roadmap_topics VALUES (79, 3, 'Decorators', 'Decorator is a design pattern in Python that allows a user to add new functionality to an existing object without modifying its structure. Decorators are usually called before the definition of a function you want to decorate.', NULL, 5, true, '2025-07-15 18:58:26.251119+05:30');
INSERT INTO public.roadmap_topics VALUES (74, 3, 'Sorting Algorithms', 'Sorting refers to arranging data in a particular format. Sorting algorithm specifies the way to arrange data in a particular order. Most common orders are in numerical or lexicographical order. The importance of sorting lies in the fact that data searching can be optimized to a very high level, if data is stored in a sorted manner.', 68, 6, true, '2025-07-15 18:41:10.592592+05:30');
INSERT INTO public.roadmap_topics VALUES (76, 3, 'Builtin Modules', 'Python has a rich standard library of built-in modules that provide a wide range of functionality. Some of the most commonly used built-in modules include: sys, os, math, datetime, random, re, itertools, etc.', 75, 1, true, '2025-07-15 18:50:04.006337+05:30');
INSERT INTO public.roadmap_topics VALUES (77, 3, 'Custom Modules', 'Modules refer to a file containing Python statements and definitions. A file containing Python code, for example: example.py, is called a module, and its module name would be example. We use modules to break down large programs into small manageable and organized files. Furthermore, modules provide reusability of code.', 75, 2, true, '2025-07-15 18:56:20.306105+05:30');
...
Examples of popular relational database systems include MySQL, PostgreSQL, Oracle, and Microsoft SQL Server. They are widely used in various applications, from small-scale projects to large enterprise systems, due to their reliability, consistency, and powerful querying capabilities.', 1, 1, true, '2025-07-14 23:30:07.665696+05:30');
INSERT INTO public.roadmap_topics VALUES (81, 3, 'Regular Expressions', 'A regular expression is a sequence of characters that specifies a search pattern in text. Usually such patterns are used by string-searching algorithms for "find" or "find and replace" operations on strings, or for input validation.', NULL, 7, true, '2025-07-15 19:03:31.557248+05:30');
INSERT INTO public.roadmap_topics VALUES (80, 3, 'Iterators', 'An iterator is an object that contains a countable number of values. An iterator is an object that can be iterated upon, meaning that you can traverse through all the values. Technically, in Python, an iterator is an object which implements the iterator protocol, which consist of the methods iter() and next().', NULL, 6, true, '2025-07-15 18:59:24.201453+05:30');
...
• HAVING: Filters the results of a GROUP BY clause based on a specified condition, similar to WHERE but for groups.', NULL, 5, true, '2025-07-15 12:34:52.542343+05:30');
...
5. **Horizontal Scalability**: RDBMSs are not as easily horizontally scalable as NoSQL databases. Scaling horizontally, which involves adding more machines to the system, can be challenging in terms of cost and complexity.', 1, 2, true, '2025-07-14 23:35:28.676458+05:30');
INSERT INTO public.roadmap_topics VALUES (52, 2, 'useReducer', 'useReducer: An alternative to useState. Accepts a reducer of type (state, action) => newState, and returns the current state paired with a dispatch method. (If you’re familiar with Redux, you already know how this works.)', 46, 6, true, '2025-07-15 13:22:46.315628+05:30');
INSERT INTO public.roadmap_topics VALUES (9, 1, 'SELECT Statement', 'SELECT is one of the most fundamental SQL commands, used to retrieve data from one or more tables in a database. It allows you to specify which columns to fetch, apply filtering conditions, sort results, and perform various operations on the data. The SELECT statement is versatile, supporting joins, subqueries, aggregations, and more, making it essential for data querying and analysis in relational databases.', 5, 4, true, '2025-07-14 23:59:53.049107+05:30');
INSERT INTO public.roadmap_topics VALUES (10, 1, 'INSERT Statement', 'The "INSERT" statement is used to add new rows of data to a table in a database. There are two main forms of the INSERT command: INSERT INTO which, if columns are not named, expects a full set of columns, and INSERT INTO table_name (column1, column2, ...) where only named columns will be filled with data.', 5, 5, true, '2025-07-15 00:04:42.212595+05:30');
INSERT INTO public.roadmap_topics VALUES (12, 1, 'DELETE Statement', 'DELETE is an SQL statement used to remove one or more rows from a table. It allows you to specify which rows to delete using a WHERE clause, or delete all rows if no condition is provided. DELETE is part of the Data Manipulation Language (DML) and is used for data maintenance, removing outdated or incorrect information, or implementing business logic that requires data removal. When used without a WHERE clause, it empties the entire table while preserving its structure, unlike the TRUNCATE command.', 5, 7, true, '2025-07-15 00:18:27.532459+05:30');
...
It effectively eliminates all records in a table, but not the table itself. Unlike the DELETE statement, TRUNCATE TABLE does not generate individual row delete statements, so the usual overhead for logging or locking does not apply.', 13, 1, true, '2025-07-15 00:24:06.037862+05:30');
INSERT INTO public.roadmap_topics VALUES (15, 1, 'ALTER TABLE', 'The ALTER TABLE statement in SQL is used to modify the structure of an existing table. This includes adding, dropping, or modifying columns, changing the data type of a column, setting default values, and adding or dropping primary or foreign keys.', 13, 2, true, '2025-07-15 00:26:01.277245+05:30');
INSERT INTO public.roadmap_topics VALUES (16, 1, 'CREATE TABLE', 'CREATE TABLE is an SQL statement used to define and create a new table in a database. It specifies the table name, column names, data types, and optional constraints such as primary keys, foreign keys, and default values. This statement establishes the structure of the table, defining how data will be stored and organized within it. CREATE TABLE is a fundamental command in database management, essential for setting up the schema of a database and preparing it to store data.', 13, 3, true, '2025-07-15 00:28:46.21536+05:30');
...
-With JSX you pass a function as the event handler, rather than a string.', 39, 5, true, '2025-07-15 13:10:53.355001+05:30');
...
Higher-order components are not commonly used in modern React code. In order to reuse logic, React hooks are mainly used now.', 39, 6, true, '2025-07-15 13:12:30.112609+05:30');
INSERT INTO public.roadmap_topics VALUES (47, 2, 'useEffect Hook', 'useEffect is a special hook that lets you run side effects in React. It is similar to componentDidMount and componentDidUpdate, but it only runs when the component (or some of its props) changes and during the initial mount.', 46, 1, true, '2025-07-15 13:17:18.471541+05:30');
INSERT INTO public.roadmap_topics VALUES (48, 2, 'useState Hook', 'useState hook is used to manage the state of a component in functional components. Calling useState returns an array with two elements: the current state value and a function to update the state.', 46, 2, true, '2025-07-15 13:18:28.636245+05:30');
INSERT INTO public.roadmap_topics VALUES (49, 2, 'useContext Hook', 'The useContext Hook lets us share data between components without having to pass props down through every level of the component tree. This is particularly useful when many components need to access the same data or when components are deeply nested.', 46, 3, true, '2025-07-15 13:19:20.405167+05:30');
INSERT INTO public.roadmap_topics VALUES (50, 2, 'useMemo', 'useMemo is a React hook that memoizes the result of a function. It is used to optimize performance by caching the result of a function and returning the cached result when the inputs to the function have not changed.', 46, 4, true, '2025-07-15 13:20:41.915016+05:30');
INSERT INTO public.roadmap_topics VALUES (51, 2, 'useRef', 'useRef is a React hook that provides a way to create a mutable reference that persists across component re-renders. It stores a value that doesn''t cause re-renders when it changes.', 46, 5, true, '2025-07-15 13:21:55.768039+05:30');
INSERT INTO public.roadmap_topics VALUES (53, 2, 'useCallback', 'useCallback is a React hook that returns a memoized version of a callback function. It''s used to optimize performance by preventing unnecessary re-renders. Specifically, it helps avoid recreating functions when their dependencies haven''t changed, which can be useful when passing callbacks to child components that rely on referential equality to prevent re-rendering.', 46, 7, true, '2025-07-15 13:23:52.874998+05:30');
INSERT INTO public.roadmap_topics VALUES (54, 2, 'Writing Custom Hooks', 'Building your own Hooks lets you extract component logic into reusable functions.', 46, 8, true, '2025-07-15 13:25:09.825477+05:30');
INSERT INTO public.roadmap_topics VALUES (55, 2, 'Hooks Best Practices', 'To fully leverage the capabilities of React Hooks, it is crucial to adopt best practices that not only enhance code readability but also optimize performance. By adhering to these practices, developers can create cleaner, more maintainable components that make the most of React''s powerful features, leading to a more efficient and enjoyable development experience.', 46, 9, true, '2025-07-15 13:26:11.141331+05:30');
INSERT INTO public.roadmap_topics VALUES (57, 3, 'Basic Syntax', 'Setup the environment for python and get started with the basics.', 56, 1, true, '2025-07-15 13:39:59.321953+05:30');
INSERT INTO public.roadmap_topics VALUES (58, 3, 'Variables and Data Types', 'Variables are used to store information to be referenced and manipulated in a computer program. They also provide a way of labeling data with a descriptive name, so our programs can be understood more clearly by the reader and ourselves. It is helpful to think of variables as containers that hold information. Their sole purpose is to label and store data in memory. This data can then be used throughout your program.', 56, 2, true, '2025-07-15 13:41:43.523379+05:30');
INSERT INTO public.roadmap_topics VALUES (59, 3, 'Conditionals', 'Conditional Statements in Python perform different actions depending on whether a specific condition evaluates to true or false. Conditional Statements are handled by if-elif-else statements and MATCH-CASE statements in Python.', 56, 3, true, '2025-07-15 15:48:23.051363+05:30');
INSERT INTO public.roadmap_topics VALUES (61, 3, 'Typecasting', 'The process of converting the value of one data type (integer, string, float, etc.) to another data type is called type conversion. Python has two types of type conversion: Implicit and Explicit.', 56, 5, true, '2025-07-15 16:57:05.006728+05:30');
INSERT INTO public.roadmap_topics VALUES (62, 3, 'Exceptions', 'Python exceptions are events that occur during the execution of a program and disrupt the normal flow of the program''s instructions. When an exception is raised, it indicates that an error has occurred. Python provides a way to handle these exceptions using try-except blocks, allowing developers to manage errors gracefully and ensure the program can continue or exit smoothly.', 56, 6, true, '2025-07-15 17:28:41.851499+05:30');
...
greet("Roadmap.sh")
```', 56, 7, true, '2025-07-15 17:32:10.686878+05:30');
...
Heap: A tree-based data structure in which the value of a parent node is ordered in a certain way with respect to the value of its child node(s). A heap can be either a min heap (the value of a parent node is less than or equal to the value of its children) or a max heap (the value of a parent node is greater than or equal to the value of its children).', 68, 3, true, '2025-07-15 18:25:05.747408+05:30');
INSERT INTO public.roadmap_topics VALUES (72, 3, 'Binary Search Trees', 'A binary search tree, also called an ordered or sorted binary tree, is a rooted binary tree data structure with the key of each internal node being greater than all the keys in the respective node''s left subtree and less than the ones in its right subtree.', 68, 4, true, '2025-07-15 18:34:15.232733+05:30');
INSERT INTO public.roadmap_topics VALUES (73, 3, 'Recursion', 'Recursion is a method of solving a computational problem where the solution depends on solutions to smaller instances of the same problem. Recursion solves such recursive problems by using functions that call themselves from within their own code.', 68, 5, true, '2025-07-15 18:35:32.504387+05:30');
